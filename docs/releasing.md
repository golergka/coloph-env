...
For the first release, register a pending publisher in your PyPI account:

| Field | Value |
| --- | --- |
| Project | `coloph-env` |
| Owner | `golergka` |
| Repository | `coloph-env` |
| Workflow | `publish.yml` |
| Environment | `pypi` |

After publication, install the version from PyPI in an isolated environment and run its CLI and library smoke tests.
Never replace a published version or tag.
